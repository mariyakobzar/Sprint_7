...
class TestLoginCourier:
    ...
    def test_login_courier_positive_result(self, register_new_courier_and_return_login_password):
    ...
    def test_login_courier_with_wrong_login_negative_result(self, register_new_courier_and_return_login_password):
        param = register_new_courier_and_return_login_password
        payload = {
            "login": param[1],
            "password": param[1]
    ...
    def test_login_courier_with_wrong_password_negative_result(self, register_new_courier_and_return_login_password):
        param = register_new_courier_and_return_login_password
        payload = {
            "login": param[1],
            "password": param[1]
    ...
    def test_login_courier_without_login_negative_result(self, register_new_courier_and_return_login_password):
        param = register_new_courier_and_return_login_password
        payload = {
            "password": param[1]
        }
    ...
    def test_login_courier_without_password_negative_result(self, register_new_courier_and_return_login_password):
        param = register_new_courier_and_return_login_password
        payload = {
            "login": param[0]
        }
    ...
    def test_login_courier_with_wrong_data_negative_result(self, register_new_courier_and_return_login_password):
        param = register_new_courier_and_return_login_password
        payload = {
            "login": f"Q+{param[0]}",
